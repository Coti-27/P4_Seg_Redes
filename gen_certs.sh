...
# Generar la CA (Llave privada y certificado raíz)
...
gen_node_cert() {
  ...
  # Archivo de configuración temporal para SAN (Requerido por Go)
...
# Generar certificados para los 3 servicios con sus IPs del diagrama
