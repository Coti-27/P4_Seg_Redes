...
# Lanzar contenedores Docker con la configuración de red especificada
...
# Generar certificados TLS mediante script
certs:
...
# Eliminar contenedores y redes Docker creadas
remove:
